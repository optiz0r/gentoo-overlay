...
ruby_add_rdepend "dev-ruby/activerecord[mysql?,postgres?,sqlite3?]"
...
all_ruby_install() {
	dodoc {LICENSE,VERSION,README.markdown,README_PACKAGES.markdown,CONTRIBUTING.md,PLUGINS.md,SELENIUM.md}
	rm .autotest .gems .gitignore LICENSE README.markdown \
