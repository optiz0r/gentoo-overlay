...
# $Header:
# /var/cvsroot/gentoo-x86/app-office/taskjuggler/taskjuggler-2.4.3.ebuild,v 1.0 2009/09/30 22:31:13 lalebarde Exp $
...
src_compile() {
	...
	use kde || myconf="${myconf}  --with-ical-support=no"
